...
Original file is located at
    https://colab.research.google.com/drive/1z1g93J1WkGtzwbg8WFca-mLIqaCUYyQp
"""

# Google Colab Notebook for CNN-Only Occupancy Prediction and Evaluation
...
# List of files to process (Only WiFi data files are included here)
file_names = [
...
# We will process each file individually inside the loop for sequence creation and model training.
...
for file_name in file_names:
    ...
    print(f"\n=======================================================")
    print(f"Processing file: {base_file_name} (CNN-Only)")
    print(f"=======================================================")
    ...
    # Convert to datetime and count users per hour
    ...
    # Create sequences (e.g., use previous 24 hours to predict the next hour)
    X, y = [], []
    ...
    model = Sequential([
        # Input shape: (sequence_length, num_features=1)
    ...
    # Train the model (Set verbose to 0 to reduce output)
    ...
    print(f"\n--- Evaluation Metrics for {location_name} (CNN-Only) ---")
    ...
    plt.plot(predictions, label='Predicted Occupancy', color='red', linestyle='--')
    plt.title(f'CNN Model: Actual vs. Predicted Occupancy for {location_name}')
...
print("\n\n=======================================================")
print("FINAL MODEL EVALUATION SUMMARY (CNN-Only)")
print("=======================================================")
# Print the final results table using markdown format
print(results_df.to_markdown(index=False, floatfmt=(".2f", ".4f", ".2f", ".2f")))

print("\n")
print(f"The evaluation metrics for your CNN models are now calculated and summarized. You can run this script and copy the final markdown table to compare it against your LSTM results.")