...
export default function GoogleButton({
  ...
  return (
    <Link
      href={href}
      className="group inline-flex w-full items-center justify-center gap-3 rounded-xl bg-[#1a2b8a] px-5 py-3 text-sm font-semibold text-white shadow-lg ring-1 ring-white/10 transition hover:-translate-y-[1px] hover:bg-[#1b34b8] focus:outline-none focus:ring-2 focus:ring-sky-400 active:translate-y-0"
    >
